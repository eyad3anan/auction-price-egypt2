...
#   • The ensemble achieves R²=0.9377 and RMSLE=0.2655 on the test set.
...
# RMSLE = 0.2655 is the calibrated log-space standard deviation from the
# test set.  Update _RMSLE after re-training.
# ---------------------------------------------------------------------------
_RMSLE  = 0.2655   # update this after every re-training run
_Z_80   = 1.282    # 80% two-sided normal z-score
_LOWER  = float(np.exp(-_Z_80 * _RMSLE))   # ≈ 0.7115
_UPPER  = float(np.exp(+_Z_80 * _RMSLE))   # ≈ 1.4055
